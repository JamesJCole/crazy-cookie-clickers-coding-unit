...
* name: Cookie Clicker — Digital Technologies
* description: Build a Cookie Clicker game while learning about branching and iteration! Choose your year level below to get started.
* primarycolor: #e67e22
* secondarycolor: #f39c12
* tertiarycolor: #d35400
* highlightcolor: #ffeaa7
* backgroundurl: https://github.com/JamesJCole/crazy-cookie-clickers-coding-unit/assets/backgrounds/skillmapBackground.png

## yr34-path

* name: Cookie Clicker — Year 3/4
* description: Build a Cookie Clicker game step by step! Learn about if/else decisions (branching) and automatic loops (iteration). Aligns with AC9TDI4P02.

### yr34-activity1

* name: The Cookie Sprite
* type: tutorial
...
* name: Year 3/4 Certificate
* type: certificate
* kind: completion
* url: /static/skillmap/certificates/yr34-cookie.pdf

## yr56-path

* name: Cookie Empire — Year 5/6
* description: Design and build a more complex Cookie Clicker game with multiple conditions, nested logic, and advanced loops. Aligns with AC9TDI6P02 and AC9TDI6P05.
...
* name: Year 5/6 Certificate
* type: certificate
* kind: completion
* url: /static/skillmap/certificates/yr56-cookie.pdf
